...
print("2 layered 128 unit SNN made weight variables and loss histogram")



if os.path.isfile((basepath+"/trained_values/trained128-2layerslr-0.00001.pt")):
	print('The file is present.')
	w1,w2,w3 = torch.load(basepath+'/trained_values/trained128-2layerslr-0.00001.pt')
else:
...
torch.save([rw1,rw2,rw3] , basepath+'/trained_values/trained128-2layerslr-0.00001.pt')
open_file = open((basepath+"/trained_values/trainedhist128-2layerslr-0.00001.pkl"),"ab")
