...
if os.path.isfile((basepath+"/trained_values/trainedrecur256lr-0.001.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/trained_values/trainedrecur256lr-0.001.pt')
	print(w1)
	print(w2)
	print(v1)
else:
...
torch.save([rw1,rw2,rv1] , basepath+'/trained_values/trainedrecur256lr-0.001.pt')
open_file = open(basepath+"/trained_values/trainedhistrecur256lr-0.001.pkl","ab")
pickle.dump(loss_list,open_file)
print("\nFile list dumped\n")
open_file.close()
print("Saved in file")
open_file = open(basepath+ "/trained_values/trainedhistrecur256lr-0.001.pkl","rb")
