...
if os.path.isfile((basepath+"/trained_values/trained256-2layerslr-0.00001.pt")):
	print('The file is present.')
	w1,w2,w3 = torch.load(basepath+'/trained_values/trained256-2layerslr-0.00001.pt')
else:
...
torch.save([rw1,rw2,rw3] , basepath+'/trained_values/trained256-2layerslr-0.00001.pt')
open_file = open((basepath+"/trained_values/trainedhist256-2layerslr-0.00001.pkl"),"ab")
