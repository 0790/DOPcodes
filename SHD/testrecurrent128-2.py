...
if os.path.isfile((basepath+"/trained_values/trainedrecurlr-2.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/trained_values/trainedrecurlr-2.pt')
...
torch.save([rw1,rw2,rv1] , basepath+'/trained_values/trainedrecurlr-2.pt')
open_file = open(basepath+"/trained_values/trainedhistrecurlr-2.pkl","ab")
pickle.dump(loss_list,open_file)
print("\nFile list dumped\n")
open_file.close()
print("Saved in file")
open_file = open(basepath+ "/trained_values/trainedhistrecurlr-2.pkl","rb")
