...
if os.path.isfile((basepath+"/trained_values/trained256-2layers.pt")):
	print('The file is present.')
	w1,w2,w3 = torch.load(basepath+'/trained_values/trained256-2layers.pt')
else:
...
torch.save([rw1,rw2,rw3] , basepath+'/trained_values/trained256-2layers.pt')
open_file = open((basepath+"/trained_values/trainedhist256-2layers.pkl"),"ab")
