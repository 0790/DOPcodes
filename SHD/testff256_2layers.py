...
if os.path.isfile((basepath+"/trained256-2layers.pt")):
	print('The file is present.')
	w1,w2,w3 = torch.load(basepath+'/trained256-2layers.pt')
else:
...
torch.save([rw1,rw2,rw3] , basepath+'/trained256-2layers.pt')
open_file = open((basepath+"/trainedhist256-2layers.pkl"),"ab")
