...
if os.path.isfile((basepath+"/trained_values/trainedunilr-0.00005.pt")):
	print('The file is present.')
	w1,w2 = torch.load(basepath+'/trained_values/trainedunilr-0.00005.pt')
else:
...
torch.save([rw1,rw2] , basepath+'/trained_values/trainedunilr-0.00005.pt')
open_file = open((basepath+"/trained_values/trainedhistunilr-0.00005.pkl"),"ab")
