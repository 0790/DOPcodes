...
weight_scale = 0.2
if os.path.isfile((basepath+"/Weights/trainedweights256_recurrentnormalTEST1.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/Weights/trainedweights256_recurrentnormalTEST1.pt')
else:
...
open_file = open((basepath+"/Plots/list256_recurrentnormalTEST1RUN1.pkl"),"ab")
