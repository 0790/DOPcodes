...
#number of neurons in each layer N = 512
...
#size of weight matrix : w1 = (700,512) w2 = (512,20)
...
weight_scale = 0.2
if os.path.isfile((basepath+"/Weights/trainedweights512_recurrentnormalTEST1.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/Weights/trainedweights512_recurrentnormalTEST1.pt')
else:
...
torch.save([rw1,rw2,rv1] , basepath+'/Weights/trainedweights512_recurrentnormalTEST1.pt')
open_file = open((basepath+"/Plots/list512_recurrentnormalTEST1RUN1.pkl"),"ab")
