...
weight_scale = 0.2
if os.path.isfile((basepath+"/Weights/trainedweights128_recurrentnormalTEST1.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/Weights/trainedweights128_recurrentnormalTEST1.pt')
else:
...
torch.save([rw1,rw2,rv1] , basepath+'/Weights/trainedweights128_recurrentnormalTEST1.pt')
open_file = open((basepath+"/Plots/list128_recurrentnormalTEST1RUN3.pkl"),"ab")
