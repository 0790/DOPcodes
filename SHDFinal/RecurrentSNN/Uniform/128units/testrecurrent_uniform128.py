...
weight_scale = 0.2
if os.path.isfile((basepath+"/Weights/trainedweights128_recurrentuniformTEST1.pt")):
	print('The file is present.')
	w1,w2,v1 = torch.load(basepath+'/Weights/trainedweights128_recurrentuniformTEST1.pt')
else:
...
torch.save([rw1,rw2,rv1] , basepath+'/Weights/trainedweights128_recurrentuniformTEST1.pt')
open_file = open((basepath+"/Plots/list128_recurrentuniformTEST1RUN2.pkl"),"ab")
