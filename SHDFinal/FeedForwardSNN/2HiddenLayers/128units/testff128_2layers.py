...
if os.path.isfile((basepath+"/Weights/trainedweights128_2layersTEST1.pt")):
	print('The file is present.')
	w1,w2,w3 = torch.load(basepath+'/Weights/trainedweights128_2layersTEST1.pt')
else:
...
open_file = open((basepath+"/Plots/list128_2layersTEST1RUN2.pkl"),"ab")
