...
if os.path.isfile((basepath+"/Weights/trainedweights128TEST1.pt")):
	print('The file is present.')
	w1,w2 = torch.load(basepath+'/Weights/trainedweights128TEST1.pt')
else:
...
torch.save([rw1,rw2] , basepath+'/Weights/trainedweights128TEST1.pt')
open_file = open((basepath+"/Plots/list128TEST1RUN4.pkl"),"ab")
