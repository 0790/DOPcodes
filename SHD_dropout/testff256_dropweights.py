...
if os.path.isfile((basepath+"/trained_values/traineddropweight256.pt")):
	print('The file is present.')
	w1,w2 = torch.load(basepath+'/trained_values/traineddropweight256.pt')
else:
...
torch.save([rw1,rw2] , basepath+'/trained_values/traineddropweight256.pt')
open_file = open((basepath+"/trained_values/trainedhistdropweight256.pkl"),"ab")
